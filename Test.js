...
var $author$project$Main$Field1 = {$: 'Field1'};
var $author$project$Main$Field2 = {$: 'Field2'};
var $author$project$Main$dummyFieldnames = _List_fromArray(
	['name', 'title', 'address', 'email', 'zip code']);
var $author$project$Main$Suggestion = F2(
	function (phrase, score) {
		return {phrase: phrase, score: score};
	});
var $author$project$Main$dummySuggestions = _List_fromArray(
	[
		A2($author$project$Main$Suggestion, 'blabla', 0.9),
		A2($author$project$Main$Suggestion, 'bloblo', 0.8),
		A2($author$project$Main$Suggestion, 'blaublau', 0.7),
		A2($author$project$Main$Suggestion, 'foobar', 0.6),
		A2($author$project$Main$Suggestion, 'foobaz', 0.5),
		A2($author$project$Main$Suggestion, 'xxxx', 0.4),
		A2($author$project$Main$Suggestion, 'yyyy', 0.3)
	]);
var $author$project$Main$emptyMenuState = {key: $elm$core$Maybe$Nothing, mouse: $elm$core$Maybe$Nothing};
var $author$project$Main$emptyCrit = function (formField) {
	return {
		fieldName: '',
		form: {completionsHowMany: 10, completionsOptions: $author$project$Main$dummySuggestions, completionsSelected: $elm$core$Maybe$Nothing, completionsShow: false, completionsState: $author$project$Main$emptyMenuState, fieldnamesHowMany: 10, fieldnamesOptions: $author$project$Main$dummyFieldnames, fieldnamesSelected: $elm$core$Maybe$Nothing, fieldnamesShow: false, fieldnamesState: $author$project$Main$emptyMenuState, formField: formField},
		mode: '',
		searchPhrase: ''
	};
};
var $author$project$Main$initialModel = {
	field1: $author$project$Main$emptyCrit($author$project$Main$Field1),
	field2: $author$project$Main$emptyCrit($author$project$Main$Field2),
	focused: $elm$core$Maybe$Nothing
};
var $author$project$Main$Focused = function (a) {
	return {$: 'Focused', a: a};
};
var $author$project$Main$SetSomeState = function (a) {
	return {$: 'SetSomeState', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$null = _Json_decodeNull;
var $elm$json$Json$Decode$oneOf = _Json_oneOf;
var $author$project$Main$focusedFetched = _Platform_incomingPort(
	'focusedFetched',
...
var $author$project$Main$MenuKeyDown = function (a) {
	return {$: 'MenuKeyDown', a: a};
};
...
var $author$project$Main$menuSubscription = $elm$browser$Browser$Events$onKeyDown(
	A2($elm$json$Json$Decode$map, $author$project$Main$MenuKeyDown, $elm$html$Html$Events$keyCode));
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$elm$core$Platform$Sub$map,
				function (m) {
					return $author$project$Main$SetSomeState(m);
				},
				$author$project$Main$menuSubscription),
				$author$project$Main$focusedFetched($author$project$Main$Focused)
			]));
};
var $author$project$Main$Completions = {$: 'Completions'};
var $author$project$Main$Fieldnames = {$: 'Fieldnames'};
var $author$project$Main$NoOp = {$: 'NoOp'};
var $author$project$Main$Reset = F2(
	function (a, b) {
...
var $author$project$Main$acceptableSuggestions = F3(
	function (s, toId, options) {
		var lowerQuery = $elm$core$String$toLower(s);
		return A2(
...
var $author$project$Main$CursorWrap = F3(
	function (a, b, c) {
		return {$: 'CursorWrap', a: a, b: b, c: c};
	});
var $author$project$Main$PreviewSuggestion = F3(
	function (a, b, c) {
		return {$: 'PreviewSuggestion', a: a, b: b, c: c};
	});
var $author$project$Main$SelectEntryKeyboard = F3(
	function (a, b, c) {
		return {$: 'SelectEntryKeyboard', a: a, b: b, c: c};
	});
var $author$project$Main$SelectEntryMouse = F3(
	function (a, b, c) {
		return {$: 'SelectEntryMouse', a: a, b: b, c: c};
	});
...
var $author$project$Main$completionsMenuUpdateConfig = function (formField) {
	return {
		onKeyDown: F2(
			function (code, maybeId) {
				return ((code === 38) || (code === 40)) ? A2(
					$elm$core$Maybe$map,
					function (b) {
						return A3($author$project$Main$PreviewSuggestion, formField, $author$project$Main$Completions, b);
					},
					maybeId) : ((code === 13) ? A2(
					$elm$core$Maybe$map,
					function (b) {
						return A3($author$project$Main$SelectEntryKeyboard, formField, $author$project$Main$Completions, b);
					},
					maybeId) : $elm$core$Maybe$Just(
					A2($author$project$Main$Reset, formField, $author$project$Main$Completions)));
			}),
		onMouseClick: function (id) {
			return $elm$core$Maybe$Just(
				A3($author$project$Main$SelectEntryMouse, formField, $author$project$Main$Completions, id));
		},
		onMouseEnter: function (id) {
			return $elm$core$Maybe$Just(
				A3($author$project$Main$PreviewSuggestion, formField, $author$project$Main$Completions, id));
		},
		onMouseLeave: function (_v0) {
			return $elm$core$Maybe$Nothing;
		},
		onTooHigh: $elm$core$Maybe$Just(
			A3($author$project$Main$CursorWrap, formField, $author$project$Main$Completions, true)),
		onTooLow: $elm$core$Maybe$Just(
			A3($author$project$Main$CursorWrap, formField, $author$project$Main$Completions, false)),
		toId: function ($) {
			return $.phrase;
		}
	};
...
var $author$project$Main$fetchFocused = _Platform_outgoingPort(
	'fetchFocused',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Main$fieldnamesMenuUpdateConfig = function (formField) {
	return {
		onKeyDown: F2(
			function (code, maybeId) {
				return ((code === 38) || (code === 40)) ? A2(
					$elm$core$Maybe$map,
					function (b) {
						return A3($author$project$Main$PreviewSuggestion, formField, $author$project$Main$Fieldnames, b);
					},
					maybeId) : ((code === 13) ? A2(
					$elm$core$Maybe$map,
					function (b) {
						return A3($author$project$Main$SelectEntryKeyboard, formField, $author$project$Main$Fieldnames, b);
					},
					maybeId) : $elm$core$Maybe$Just(
					A2($author$project$Main$Reset, formField, $author$project$Main$Fieldnames)));
			}),
		onMouseClick: function (id) {
			return $elm$core$Maybe$Just(
				A3($author$project$Main$SelectEntryMouse, formField, $author$project$Main$Fieldnames, id));
		},
		onMouseEnter: function (id) {
			return $elm$core$Maybe$Just(
				A3($author$project$Main$PreviewSuggestion, formField, $author$project$Main$Fieldnames, id));
		},
		onMouseLeave: function (_v0) {
			return $elm$core$Maybe$Nothing;
		},
		onTooHigh: $elm$core$Maybe$Just(
			A3($author$project$Main$CursorWrap, formField, $author$project$Main$Fieldnames, true)),
		onTooLow: $elm$core$Maybe$Just(
			A3($author$project$Main$CursorWrap, formField, $author$project$Main$Fieldnames, false)),
		toId: $elm$core$Basics$identity
	};
};
var $elm$browser$Browser$Dom$focus = _Browser_call('focus');
var $author$project$Main$getCritFromSearch = F2(
	function (formField, model) {
		return _Utils_eq(model.field1.form.formField, formField) ? model.field1 : (_Utils_eq(model.field2.form.formField, formField) ? model.field2 : model.field1);
	});
...
var $author$project$Main$getSuggestionAtId = F4(
	function (options, id, toId, _default) {
		return A2(
...
var $author$project$Main$setCritToSearch = F3(
	function (formField, crit, model) {
		return _Utils_eq(model.field1.form.formField, formField) ? _Utils_update(
			model,
			{field1: crit}) : (_Utils_eq(model.field2.form.formField, formField) ? _Utils_update(
			model,
			{field2: crit}) : model);
	});
var $author$project$Main$removeMenuSelection = F3(
	function (formField, mode, model) {
		...
		var newForm = function () {
			if (mode.$ === 'Completions') {
				return _Utils_update(
					oldForm,
					{completionsSelected: $elm$core$Maybe$Nothing});
			} else {
				return _Utils_update(
					oldForm,
					{fieldnamesSelected: $elm$core$Maybe$Nothing});
			}
		}();
...
var $author$project$Main$resetMenu = F3(
	function (formField, mode, model) {
		var crit = A2($author$project$Main$getCritFromSearch, formField, model);
		var oldForm = crit.form;
		var newForm = function () {
			if (mode.$ === 'Completions') {
				return _Utils_update(
					oldForm,
					{completionsShow: false, completionsState: $author$project$Main$emptyMenuState});
			} else {
				return _Utils_update(
					oldForm,
					{fieldnamesShow: false, fieldnamesState: $author$project$Main$emptyMenuState});
			}
		}();
		var newField = _Utils_update(
			crit,
...
var $author$project$Main$resetMenuInput = F3(
	function (formField, mode, model) {
		var crit = A2($author$project$Main$getCritFromSearch, formField, model);
		...
		var newModel = A3($author$project$Main$setCritToSearch, formField, newField, model);
		return A3(
			$author$project$Main$resetMenu,
			formField,
			mode,
			A3($author$project$Main$removeMenuSelection, formField, mode, newModel));
	});
var $author$project$Main$resetToFirst = F3(
	function (config, data, state) {
		...
		var _v0 = $elm$core$List$head(data);
		if (_v0.$ === 'Nothing') {
			return $author$project$Main$emptyMenuState;
		} else {
			var datum = _v0.a;
			return A2(setFirstItem, datum, $author$project$Main$emptyMenuState);
		}
	});
...
var $author$project$Main$resetToFirstItem = F4(
	function (config, data, howManyToShow, state) {
		return A3(
			$author$project$Main$resetToFirst,
			config,
			A2($elm$core$List$take, howManyToShow, data),
			state);
	});
var $author$project$Main$resetToLastItem = F4(
	function (config, data, howManyToShow, state) {
		var reversedData = $elm$core$List$reverse(
			A2($elm$core$List$take, howManyToShow, data));
		return A3($author$project$Main$resetToFirst, config, reversedData, state);
	});
var $author$project$Main$setQuery = F4(
	function (id, formField, mode, model) {
		var crit = A2($author$project$Main$getCritFromSearch, formField, model);
		var oldForm = crit.form;
		var newForm = function () {
			if (mode.$ === 'Completions') {
				return _Utils_update(
					oldForm,
					{
						completionsSelected: $elm$core$Maybe$Just(
							A4(
								$author$project$Main$getSuggestionAtId,
								oldForm.completionsOptions,
								id,
								function ($) {
									return $.phrase;
								},
								A2($author$project$Main$Suggestion, '', 0)))
					});
			} else {
				return _Utils_update(
					oldForm,
					{
						fieldnamesSelected: $elm$core$Maybe$Just(
							A4($author$project$Main$getSuggestionAtId, oldForm.fieldnamesOptions, id, $elm$core$Basics$identity, ''))
					});
			}
		}();
		var newField = function () {
			if (mode.$ === 'Completions') {
				...
				return _Utils_update(
					crit,
					{
						fieldName: A4($author$project$Main$getSuggestionAtId, oldForm.fieldnamesOptions, id, $elm$core$Basics$identity, ''),
						form: newForm
					});
			}
		}();
...
var $author$project$Main$MenuWentTooHigh = {$: 'MenuWentTooHigh'};
var $author$project$Main$MenuWentTooLow = {$: 'MenuWentTooLow'};
var $author$project$Main$getPrevious = F3(
...
var $author$project$Main$getNextItemId = F2(
	function (ids, selectedId) {
		return A2(
			...
			A3(
				$elm$core$List$foldl,
				$author$project$Main$getPrevious(selectedId),
				$elm$core$Maybe$Nothing,
				ids));
	});
var $author$project$Main$getPreviousItemId = F2(
	function (ids, selectedId) {
		return A2(
			$elm$core$Maybe$withDefault,
			selectedId,
...
var $author$project$Main$navigateWithKey = F3(
	function (code, ids, maybeId) {
		switch (code) {
			case 38:
				return A2(
					$elm$core$Maybe$map,
					$author$project$Main$getPreviousItemId(ids),
					maybeId);
			case 40:
				return A2(
					$elm$core$Maybe$map,
					$author$project$Main$getNextItemId(ids),
					maybeId);
			default:
				return maybeId;
		}
	});
var $author$project$Main$resetMouseStateWithId = F2(
	function (id, state) {
		return {
...
var $author$project$Main$updateMenu = F5(
		...
		while (true) {
			switch (msg.$) {
				case 'MenuKeyDown':
					...
					var newKey = A3($author$project$Main$navigateWithKey, keyCode, boundedList, state.key);
					if (_Utils_eq(newKey, state.key) && (keyCode === 38)) {
						var $temp$config = config,
							$temp$msg = $author$project$Main$MenuWentTooHigh,
						...
						if (_Utils_eq(newKey, state.key) && (keyCode === 40)) {
							var $temp$config = config,
								$temp$msg = $author$project$Main$MenuWentTooLow,
								$temp$howManyToShow = howManyToShow,
								$temp$state = state,
								$temp$data = data;
							config = $temp$config;
				...
				case 'MenuMouseClick':
					var id = msg.a;
					return _Utils_Tuple2(
						A2($author$project$Main$resetMouseStateWithId, id, state),
		...
		while (true) {
			switch (msg.$) {
				case 'CursorWrap':
					...
					var newForm = function () {
						if (mode.$ === 'Completions') {
							return toTop ? _Utils_update(
								oldForm,
								{
									completionsSelected: $elm$core$List$head(
										$elm$core$List$reverse(
											A2(
												...
												A3(
													...
													oldForm.completionsOptions)))),
									completionsState: A4(
										$author$project$Main$resetToLastItem,
										$author$project$Main$completionsMenuUpdateConfig(formField),
										A3(
											$author$project$Main$acceptableSuggestions,
											crit.searchPhrase,
											function ($) {
									...
									completionsSelected: $elm$core$List$head(
										A2(
											...
											A3(
												...
												oldForm.completionsOptions))),
									completionsState: A4(
										$author$project$Main$resetToFirstItem,
										$author$project$Main$completionsMenuUpdateConfig(formField),
										A3(
											$author$project$Main$acceptableSuggestions,
											crit.searchPhrase,
							...
							return toTop ? _Utils_update(
								oldForm,
								{
									fieldnamesSelected: $elm$core$List$head(
										$elm$core$List$reverse(
											A2(
												$elm$core$List$take,
												oldForm.fieldnamesHowMany,
												A3($author$project$Main$acceptableSuggestions, crit.fieldName, $elm$core$Basics$identity, oldForm.fieldnamesOptions)))),
									fieldnamesState: A4(
										$author$project$Main$resetToLastItem,
										$author$project$Main$fieldnamesMenuUpdateConfig(formField),
										A3($author$project$Main$acceptableSuggestions, crit.fieldName, $elm$core$Basics$identity, oldForm.fieldnamesOptions),
										oldForm.fieldnamesHowMany,
					...
					if (mode.$ === 'Completions') {
						var _v2 = crit.form.completionsSelected;
						if (_v2.$ === 'Just') {
							var $temp$msg = A2($author$project$Main$Reset, formField, mode),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						...
						if (mode.$ === 'Completions') {
							return !$elm$core$List$isEmpty(
								A3(
									...
									crit.form.completionsOptions));
						} else {
							return !$elm$core$List$isEmpty(
								A3($author$project$Main$acceptableSuggestions, crit.fieldName, $elm$core$Basics$identity, crit.form.fieldnamesOptions));
						}
					}();
					var handleEscape = F2(
						function (a, b) {
							return validOptions ? A3(
								$author$project$Main$resetMenu,
								a,
								b,
								A3($author$project$Main$removeMenuSelection, a, b, model)) : A3($author$project$Main$resetMenuInput, a, b, model);
						});
					var escapedModel = function () {
						if (mode.$ === 'Completions') {
							var _v5 = crit.form.completionsSelected;
							if (_v5.$ === 'Just') {
								var s = _v5.a;
								return _Utils_eq(crit.searchPhrase, s.phrase) ? A3($author$project$Main$resetMenuInput, formField, mode, model) : A2(handleEscape, formField, mode);
							} else {
								return A2(handleEscape, formField, mode);
							}
						} else {
							var _v6 = crit.form.fieldnamesSelected;
							if (_v6.$ === 'Just') {
								var s = _v6.a;
								return _Utils_eq(crit.fieldName, s) ? A3($author$project$Main$resetMenuInput, formField, mode, model) : A2(handleEscape, formField, mode);
							} else {
								return A2(handleEscape, formField, mode);
							}
						}
				...
				case 'FetchFocused':
					return _Utils_Tuple2(
						model,
						$author$project$Main$fetchFocused(_Utils_Tuple0));
				case 'Focused':
					var id = msg.a;
					var newModel = function () {
						if (id.$ === 'Just') {
							var s = id.a;
							switch (s) {
								case 'Field1_searchPhrase':
									return _Utils_update(
										model,
										{
											focused: $elm$core$Maybe$Just(
												_Utils_Tuple2($author$project$Main$Field1, $author$project$Main$Completions))
										});
								case 'Field2_searchPhrase':
									return _Utils_update(
										model,
										{
											focused: $elm$core$Maybe$Just(
												_Utils_Tuple2($author$project$Main$Field2, $author$project$Main$Completions))
										});
								case 'Field1_fieldName':
									return _Utils_update(
										model,
										{
											focused: $elm$core$Maybe$Just(
												_Utils_Tuple2($author$project$Main$Field1, $author$project$Main$Fieldnames))
										});
								case 'Field2_fieldName':
									return _Utils_update(
										model,
										{
											focused: $elm$core$Maybe$Just(
												_Utils_Tuple2($author$project$Main$Field2, $author$project$Main$Fieldnames))
										});
								default:
									return _Utils_update(
										model,
				...
				case 'Reset':
					...
					var newForm = function () {
						if (mode.$ === 'Completions') {
							return _Utils_update(
								oldForm,
								{completionsSelected: $elm$core$Maybe$Nothing, completionsState: $author$project$Main$emptyMenuState});
						} else {
							return _Utils_update(
								oldForm,
								{fieldnamesSelected: $elm$core$Maybe$Nothing, fieldnamesState: $author$project$Main$emptyMenuState});
						}
					}();
					var newField = _Utils_update(
						crit,
				...
				case 'SelectEntryKeyboard':
					...
					var newModel = A3(
						...
						formField,
						mode,
						A4($author$project$Main$setQuery, id, formField, mode, model));
					return _Utils_Tuple2(newModel, $elm$core$Platform$Cmd$none);
				case 'SelectEntryMouse':
					var formField = msg.a;
					var mode = msg.b;
					var id = msg.c;
					var newModel = A3(
					...
					return _Utils_Tuple2(
						...
						A2(
							...
							$elm$browser$Browser$Dom$focus('quicksearch-input')));
				case 'SetSomeState':
					var autoMsg = msg.a;
					var _v13 = function () {
						var _v14 = model.focused;
						if (_v14.$ === 'Just') {
							var _v15 = _v14.a;
							var a = _v15.a;
							var b = _v15.b;
							...
							return _Utils_Tuple2($author$project$Main$Field1, $author$project$Main$Completions);
						}
					}();
					var openMenuField = _v13.a;
					var mode = _v13.b;
					var crit = A2($author$project$Main$getCritFromSearch, openMenuField, model);
					var oldForm = crit.form;
					var _v16 = function () {
						if (mode.$ === 'Completions') {
							return A5(
								$author$project$Main$updateMenu,
								$author$project$Main$completionsMenuUpdateConfig(openMenuField),
								autoMsg,
								oldForm.completionsHowMany,
								oldForm.completionsState,
								A3(
							...
							return A5(
								$author$project$Main$updateMenu,
								$author$project$Main$fieldnamesMenuUpdateConfig(openMenuField),
								autoMsg,
								oldForm.fieldnamesHowMany,
								oldForm.fieldnamesState,
								A3($author$project$Main$acceptableSuggestions, crit.fieldName, $elm$core$Basics$identity, oldForm.fieldnamesOptions));
					...
					var newForm = function () {
						if (mode.$ === 'Completions') {
							return _Utils_update(
								oldForm,
								{completionsState: newState});
						} else {
							return _Utils_update(
								oldForm,
								{fieldnamesState: newState});
						}
					}();
					var newField = _Utils_update(
						crit,
						{form: newForm});
					var newModel = A3($author$project$Main$setCritToSearch, openMenuField, newField, model);
					return A2(
						$elm$core$Maybe$withDefault,
						...
						A2(
							$elm$core$Maybe$map,
							function (updateMsg) {
								return A2($author$project$Main$update, updateMsg, newModel);
							},
							maybeMsg));
				case 'SetState':
					var formField = msg.a;
				...
				case 'UserTypedText':
					...
					var newForm = function () {
						if (mode.$ === 'Completions') {
							return _Utils_update(
								oldForm,
								{completionsOptions: oldForm.completionsOptions, completionsSelected: $elm$core$Maybe$Nothing, completionsShow: newShow});
						} else {
							return _Utils_update(
								oldForm,
								{fieldnamesOptions: oldForm.fieldnamesOptions, fieldnamesSelected: $elm$core$Maybe$Nothing, fieldnamesShow: newShow});
						}
					}();
					var newField = function () {
						if (mode.$ === 'Completions') {
...
var $author$project$Main$FetchFocused = {$: 'FetchFocused'};
var $author$project$Main$Submit = {$: 'Submit'};
var $author$project$Main$UserTypedText = F3(
	function (a, b, c) {
				...
				return $mdgriffith$elm_ui$Element$htmlAttribute(
					A2(
						...
						A2(
							$elm$json$Json$Decode$andThen,
							function (key) {
								return (key === 'Enter') ? $elm$json$Json$Decode$succeed(m) : $elm$json$Json$Decode$fail('Not the enter key');
							},
							A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string))));
			} else {
				return $mdgriffith$elm_ui$Element$htmlAttribute(
...
var $author$project$Main$HandleEscape = F2(
	function (a, b) {
		return {$: 'HandleEscape', a: a, b: b};
	});
var $author$project$Main$upDownEscDecoderHelper = F4(
	function (formField, mode, model, code) {
		var crit = A2($author$project$Main$getCritFromSearch, formField, model);
		return ((code === 38) || (code === 40)) ? $elm$json$Json$Decode$succeed($author$project$Main$NoOp) : ((code === 27) ? $elm$json$Json$Decode$succeed(
			A2($author$project$Main$HandleEscape, formField, mode)) : $elm$json$Json$Decode$fail('not handling that key'));
	});
var $author$project$Main$upDownEscDecoder = F3(
	function (formField, mode, model) {
		return A2(
			$elm$json$Json$Decode$map,
			function (msg) {
			...
			A2(
				$elm$json$Json$Decode$andThen,
				A3($author$project$Main$upDownEscDecoderHelper, formField, mode, model),
				$elm$html$Html$Events$keyCode));
	});
var $author$project$Main$SetState = F3(
	function (a, b, c) {
		return {$: 'SetState', a: a, b: b, c: c};
	});
...
var $author$project$Main$fieldnamesMenuViewConfig = function () {
	var customizedLi = F3(
		function (keySelected, mouseSelected, suggestion) {
			return {
				attributes: _List_fromArray(
					[
						...
						$elm$html$Html$Attributes$id(suggestion),
						(keySelected || mouseSelected) ? A2($elm$html$Html$Attributes$style, 'font-weight', 'bold') : A2($elm$html$Html$Attributes$style, 'font-weight', 'normal')
					]),
...
var $author$project$Main$NoMenuOp = {$: 'NoMenuOp'};
var $elm$virtual_dom$VirtualDom$mapAttribute = _VirtualDom_mapAttribute;
var $elm$html$Html$Attributes$map = $elm$virtual_dom$VirtualDom$mapAttribute;
var $author$project$Main$mapNeverToMsg = function (msg) {
	return A2(
		$elm$html$Html$Attributes$map,
		function (_v0) {
			return $author$project$Main$NoMenuOp;
		},
		msg);
};
var $elm$html$Html$Keyed$ul = $elm$html$Html$Keyed$node('ul');
var $author$project$Main$MenuMouseClick = function (a) {
	return {$: 'MenuMouseClick', a: a};
};
var $author$project$Main$MenuMouseEnter = function (a) {
	return {$: 'MenuMouseEnter', a: a};
};
var $author$project$Main$MenuMouseLeave = function (a) {
	return {$: 'MenuMouseLeave', a: a};
};
...
var $author$project$Main$viewItem = F3(
	function (_v0, _v1, data) {
		...
		var listItemData = A3(
			...
			isSelected(mouse),
			data);
		var customAttributes = A2($elm$core$List$map, $author$project$Main$mapNeverToMsg, listItemData.attributes);
		var customLiAttr = A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$MenuMouseEnter(id)),
					$elm$html$Html$Events$onMouseLeave(
					$author$project$Main$MenuMouseLeave(id)),
					$elm$html$Html$Events$onClick(
					$author$project$Main$MenuMouseClick(id))
				]));
		return A2(
			$elm$html$Html$li,
			customLiAttr,
...
var $author$project$Main$menuView = F4(
	function (config, howManyToShow, state, data) {
		var getKeyedItems = function (datum) {
			return _Utils_Tuple2(
				config.toId(datum),
				A3($author$project$Main$viewItem, config, state, datum));
		};
		var customUlAttr = A2($elm$core$List$map, $author$project$Main$mapNeverToMsg, config.ul);
		return A2(
...
var $author$project$Main$smartFieldField = F3(
	function (formField, defaultValue, oldSearch) {
		...
		var oldForm = oldField.form;
		var query = A2($elm$core$Maybe$withDefault, oldField.fieldName, oldForm.fieldnamesSelected);
		var htmlFieldname = function () {
			if (formField.$ === 'Field1') {
				return 'Field1_fieldName';
			} else {
				...
				[
						...
						_List_fromArray(
							[
								...
								A2(
									$elm$html$Html$Events$preventDefaultOn,
									'keydown',
									A3($author$project$Main$upDownEscDecoder, formField, $author$project$Main$Fieldnames, oldSearch))),
								$mdgriffith$elm_ui$Element$htmlAttribute(
								...
								]))),
					{
						label: A2(
							...
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('')),
						onChange: A2($author$project$Main$UserTypedText, formField, $author$project$Main$Fieldnames),
			...
			return {
				attributes: _List_fromArray(
					[
						...
						$elm$html$Html$Attributes$id(suggestion.phrase),
						(keySelected || mouseSelected) ? A2($elm$html$Html$Attributes$style, 'font-weight', 'bold') : A2($elm$html$Html$Attributes$style, 'font-weight', 'normal')
					]),
				children: _List_fromArray(
					[
						$elm$html$Html$text(suggestion.phrase)
					])
			};
		});
	return {
...
var $author$project$Main$smartTextField = F2(
	function (formField, oldSearch) {
		...
		var htmlFieldname = function () {
			if (formField.$ === 'Field1') {
				return 'Field1_searchPhrase';
			} else {
				return 'Field2_searchPhrase';
			}
		}();
		var completionsMenu = oldForm.completionsShow ? A2($author$project$Main$viewCompletionsMenu, formField, oldField) : $mdgriffith$elm_ui$Element$none;
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
				...
				[
						...
						_List_fromArray(
							[
								...
								A2(
									$elm$html$Html$Events$preventDefaultOn,
									'keydown',
									A3($author$project$Main$upDownEscDecoder, formField, $author$project$Main$Completions, oldSearch))),
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$elm$html$Html$Attributes$value(query)),
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$elm$html$Html$Attributes$id(htmlFieldname)),
								...
								]))),
					{
						label: A2(
							...
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('')),
						onChange: A2($author$project$Main$UserTypedText, formField, $author$project$Main$Completions),
						placeholder: $elm$core$Maybe$Just(
							A2(
								$mdgriffith$elm_ui$Element$Input$placeholder,
								_List_Nil,
			...
			_List_fromArray(
				[
						...
						]),
					{
						...
						selected: $elm$core$Maybe$Just(oldField.mode)
					}),
					A3($author$project$Main$smartFieldField, formField, defaultField, oldSearch),
					A2($author$project$Main$smartTextField, formField, oldSearch)
				]));
	});
		...
		A2(
			...
			_List_fromArray(
				[
					...
					A3($author$project$Main$critForm, $author$project$Main$Field2, 'title', model)
				])));
};
